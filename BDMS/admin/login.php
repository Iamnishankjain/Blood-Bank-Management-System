...
<body background="admin_image\blood-cells.jpg">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:20px;">
      <div class="row justify-content-center">
          <div class="col-lg-6">
              <center><h1 class="mt-4 mb-3" style="color:Red ;">
  ...
  <div class="row justify-content-lg-center justify-content-mb-center">
    ...
    <H6><a href="forgot.php">forgot password</a></H6><br>
    <div><input type="submit" name="login" class="btn btn-primary" value="LOGIN" style="cursor:pointer"><br></div>
    <br><br>
    <H1><center><a href="http://localhost/bdms/">Home Page </a></center></H1>
    </div>
  </div></center>
    </div>
  </div></div>
