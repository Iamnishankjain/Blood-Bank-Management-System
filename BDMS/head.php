...
<body>
  <div class="header">
    <a href="home.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>>Life Saver Blood Bank </a>
    ...
    <a href="why_donate_blood.php"  <?php if($active=='why') echo "class='act'"; ?>>Why Donate Blood</a>
      ...
      <a href="http://localhost/bdms/admin/login.php" <?php if($active=='Login') echo "class='act'"; ?>>Admin Log in</a>
    </div>
  </div>
