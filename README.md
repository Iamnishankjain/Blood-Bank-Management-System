...
3. Download project from github(https://github.com/Iamnishankjain/Blood-Bank-Management-System.git).

   OR follow gitbash commands <br>
     ```t
         i>cd C:\\xampp\htdocs\
        ii>git clone https://github.com/Iamnishankjain/Blood-Bank-Management-System.git
...
# Admin Panel
   ...
   <b> Username = </b>nishank<br>
   <b>Password = </b> nishank
